	...
	/***************************************************************************************
		NOMBRE DE LA FUNCI�N :	blocking(nr)
		ARGUMENTOS :			nr :	Cadena con el nombre del objeto que quiero 
										aparecer/desaparecer.
		RETORNO :				SR (sin retorno)
		FUNCIONALIDAD : 
		 Esta funci�n aparece/desaparece un elemento/objeto de una forma.
		ANOTACIONES :
		- Esta funci�n desaparece ese objeto como si quitara el objeto, aunque lo que 
		  este incluido dentro de el permanecera con las mismas propiedades para ser 
		  evaluadas.
		Creado Por :		Jos� Fernando Mendoza
	...
	***************************************************************************************/
	...
	/***************************************************************************************
		NOMBRE DE LA FUNCI�N :	visi(nr)
		ARGUMENTOS :			nr : 	Cadena con el nombre del objeto que quiero
										visibilizar/invisibilizar.
		RETORNO :				SR (sin retorno)
		FUNCIONALIDAD : 
		 Esta funci�n visibilizar/invisibilizar un elemento/objeto de una forma.
		ANOTACIONES :
		- Esta funcion desaparece el objeto pero el espacio en el que se encontraba seguira 
		  siendo ocupado a�n si no se ve.
...
/***************************************************************************************
		...
		NOTES         :
		CREATE BY     :	Jos� Fernando Mendoza
