...
<input type="radio"/>
  ...
  <div id="proveedores" class="col s12 container">
    <section>
      <br>
      {tools_ancla 
               li_class = "tab col s6,tab col s6"
               href = "#proveedor,#crearpro"
               labels = "prov,new"
               id = "prueba1,prueba2"
      }
            ...
            <div>
                {form name="Form_prove" method="GET"}
                    ...
                    {tools_barstandard type = "Button"
                                  ...
                                  commands = "CmdShowByIdProveedor,CmdDeleteProveedor"
                                  icon_class="fa-pencil-square-o,fa-trash"
                                  btn_class = "waves-effect waves-light btn modal-trigger,btn-info,btn-danger"
                                  labels = "edit,del"
                                  id = "updateprov,deleteprov"
                    }    
                    {* <a href="#update_prove" class="waves-effect waves-light btn modal-trigger">Editar <i class="material-icons left">edit</i></a>
                    <a href="" onclik="Form_prove.submit();" class="waves-effect waves-light btn">Eliminar <i class="material-icons left">delete</i></a>*}
  ...
  <!--<div id="update_prove" class="modal">
    <div class="modal-content">
      <form action="">
        <div class="input-field">
          {textfield id="proveedor" type="text" value='$nombre_prov'}
