<?php
/* Smarty version 3.1.30, created on 2018-11-07 20:36:01
  from "C:\xampp\htdocs\LittlePHP_VENI_COMPRA\LitlePHP\applications\veni_compra\web\html\Form_index.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5be33ea17428c7_80710967',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '1fcd4eee06af501d46485beedaf693c3c9488263' => 
    array (
      0 => 'C:\\xampp\\htdocs\\LittlePHP_VENI_COMPRA\\LitlePHP\\applications\\veni_compra\\web\\html\\Form_index.tpl',
      1 => 1541619354,
      2 => 'file',
    ),
  ),
...
function content_5be33ea17428c7_80710967 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html>
    ...
    <div class="nav-wrapper">
      <div class="container">
        ...
        <ul id="nav-mobile" class="right hide-on-med-and-down">
          ...
          <li><a href="index.php?action=CmdDefaultLogin">Iniciar<i class="material-icons right">account_circle</i></a></li>
    ...
    <ul class="slides blue">
      <li>
        <a href="promociones.html">
          <img src="./web/img/carousel/slider-0.jpg" class="img-responsive" alt="">
        </a>
      ...
      <li>
        <a href="promociones.html">
          <img src="./web/img/carousel/slider-1.jpg" class="responsive-img" alt="">
        </a>
      ...
      <li>
        <a href="promociones.html">
          <img src="./web/img/carousel/slider-2.jpg" class="responsive-img" alt="">
        </a>
    ...
    <div class="row">
      <div class="col s12 m6 l4">
        <div class="card hoverable">
          <div class="card-image waves-effect waves-block waves-light">
            <div class="boton">
              <img src="web/img/card/hat-1.jpg" alt="">
              <div class="overlay">
                <div class="botones">
      ...
      <div class="col s12 m6 l4">
        <div class="card hoverable">
          <div class="card-image waves-effect waves-block waves-light">
            <div class="boton">
              <img src="web/img/card/shirt-2.jpeg" alt="">
              <div class="overlay">
                <div class="botones">
                  <a href="producto.html" class="fa"><i class="material-icons white-text">favorite</i></a>
                  <a href="producto.html" class="fa"><i class="material-icons white-text">forward</i></a>
      ...
      <div class="col s12 m6 l4">
        <div class="card hoverable">
          <div class="card-image waves-effect waves-block waves-light">
            <div class="boton">
              <img src="web/img/card/ryzen.png" alt="">
              <div class="overlay">
                <div class="botones">
                  <a href="producto.html" class="fa"><i class="material-icons white-text">favorite</i></a>
                  <a href="producto.html" class="fa"><i class="material-icons white-text">forward</i></a>
      ...
      <div class="col s12 m6 l4">
        <div class="card hoverable">
          <div class="card-image waves-effect waves-block waves-light">
            <div class="boton">
              <img src="web/img/card/ball.jpg" alt="">
              <div class="overlay">
                <div class="botones">
                  <a href="producto.html" class="fa"><i class="material-icons white-text">favorite</i></a>
                  <a href="producto.html" class="fa"><i class="material-icons white-text">forward</i></a>
      ...
      <div class="col s12 m6 l4">
        <div class="card hoverable">
          <div class="card-image waves-effect waves-block waves-light">
            <div class="boton">
              <img src="web/img/card/tv.jpg" alt="">
              <div class="overlay">
                <div class="botones">
                  <a href="producto.html" class="fa"><i class="material-icons white-text">favorite</i></a>
                  <a href="producto.html" class="fa"><i class="material-icons white-text">forward</i></a>
      ...
      <div class="col s12 m6 l4">
        <div class="card hoverable">
          <div class="card-image waves-effect waves-block waves-light">
            <div class="boton">
              <img src="web/img/card/xbox.jpg" alt="">
              <div class="overlay">
                <div class="botones">
                  <a href="producto.html" class="fa"><i class="material-icons white-text">favorite</i></a>
                  <a href="producto.html" class="fa"><i class="material-icons white-text">forward</i></a>
    ...
    <div class="row">
      <div class="col s6 m4 l2">
        <a href="resultados.html">
          <div class="category hoverable">
            <div class="image">
              <img src="web/img/categorias/camera.svg" alt="">
            </div>
            <div class="content">
      ...
      <div class="col s6 m4 l2">
        <a href="resultados.html">
          <div class="category hoverable">
            <div class="image">
              <img src="web/img/categorias/pc.svg" alt="">
            </div>
            <div class="content">
      ...
      <div class="col s6 m4 l2">
        <a href="resultados.html">
          <div class="category hoverable">
            <div class="image">
              <img src="web/img/categorias/gamepad.svg" alt="">
            </div>
            <div class="content">
              <span>Juegos</span>
            </div>
      ...
      <div class="col s6 m4 l2">
        <a href="resultados.html">
          <div class="category hoverable">
            <div class="image">
              <img src="web/img/categorias/running.svg" alt="">
            </div>
            <div class="content">
              <span>Fitness</span>
            </div>
      ...
      <div class="col s6 m4 l2">
        <a href="resultados.html">
          <div class="category hoverable">
            <div class="image">
              <img src="web/img/categorias/animal-paw-print.svg" alt="">
            </div>
            <div class="content">
              <span>Mascotas</span>
            </div>
      ...
      <div class="col s6 m4 l2">
        <a href="resultados.html">
          <div class="category hoverable">
            <div class="image">
              <img src="web/img/categorias/engineer.svg" alt="">
            </div>
            <div class="content">
      ...
      <div class="col s6 m4 l2">
        <a href="resultados.html">
          <div class="category hoverable">
            <div class="image">
              <img src="web/img/categorias/robotic.svg" alt="">
            </div>
            <div class="content">
              <span>Juguetes</span>
            </div>
      ...
      <div class="col s6 m4 l2">
        <a href="resultados.html">
          <div class="category hoverable">
            <div class="image">
              <img src="web/img/categorias/makeup.svg" alt="">
            </div>
            <div class="content">
      ...
      <div class="col s6 m4 l2">
        <a href="resultados.html">
          <div class="category hoverable">
            <div class="image">
              <img src="web/img/categorias/laundry.svg" alt="">
            </div>
            <div class="content">
              <span>Ropa</span>
            </div>
      ...
      <div class="col s6 m4 l2">
        <a href="resultados.html">
          <div class="category hoverable">
            <div class="image">
              <img src="web/img/categorias/headphones.svg" alt="">
            </div>
            <div class="content">
              <span>Musica</span>
            </div>
      ...
      <div class="col s6 m4 l2">
        <a href="resultados.html">
          <div class="category hoverable">
            ...
            <div class="image">
              <img src="web/img/categorias/avengers.svg" alt="">
            </div>
            <div class="content">
              <span>Comics</span>
            </div>
      ...
      <div class="col s6 m4 l2">
        <div class="category hoverable">
          <div class="image">
            <img src="web/img/categorias/vegetables.svg" alt="">
          </div>
          <div class="content">
            <span>Comida</span>
          </div>
